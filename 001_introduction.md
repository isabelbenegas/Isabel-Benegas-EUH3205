...
{% assign media = site.media_metadata | where_exp: “item”, “item.name == ‘spinningroomWorks’” %} {% include media.html pages=media %}

[Britanica](https://www.britannica.com/event/Industrial-Revolution)
